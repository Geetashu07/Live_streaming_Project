...
kafka_config = {
    ...
    'sasl.username': 'C357VTUFAQRV2FUT',
    'sasl.password': 'tnag96KG5WEa4MEUzzrZNBfDfVOe5xyXMpN3hUNpxKvC07DaUaMq1O41u/BHzBxk'
}

# Create a Schema Registry client
schema_registry_client = SchemaRegistryClient({
  'url': 'https://psrc-gqrvzv.southeastasia.azure.confluent.cloud',
  'basic.auth.user.info': '{}:{}'.format('X7UH33H4HCXFN42A', 'WwmiX5arKkzRBeLHyAolSecnHGE3wg84t8pjjtXeaUyz7H7h1bQHTkG29qxVA1qG')
})
